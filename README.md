...
> 说明：当前 DMG 是未签名、未公证的测试包，适合小范围试用。首次打开可能需要右键 App 选择“打开”。
...
> Note: the current DMG is unsigned and not notarized. It is suitable for small test distribution. On first launch, macOS may require right-clicking the app and choosing “Open”.
